...
# Usage:
#   ./generate_remodeled_Deepbench_nvidia_tencore_gemm_traces.sh -D 0
#   ./generate_remodeled_Deepbench_nvidia_tencore_gemm_traces.sh 0
...
echo "Benchmark suite=Deepbench_nvidia_tencore_gemm"
echo "Build target=Deepbench_nvidia_tencore_gemm"
...
make -j"$(nproc)" -C ./gpu-app-collection/src Deepbench_nvidia_tencore_gemm
make -C ./gpu-app-collection/src data

./util/tracer_nvbit/run_hw_trace.py -B Deepbench_nvidia_tencore_gemm -D "$DEVICE"
