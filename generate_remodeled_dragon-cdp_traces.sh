...
# Usage:
#   ./generate_remodeled_dragon-cdp_traces.sh -D 0
#   ./generate_remodeled_dragon-cdp_traces.sh 0
...
echo "Benchmark suite=dragon-cdp"
echo "Build target=dragon-cdp"
...
make -j"$(nproc)" -C ./gpu-app-collection/src dragon-cdp
make -C ./gpu-app-collection/src data

./util/tracer_nvbit/run_hw_trace.py -B dragon-cdp -D "$DEVICE"
