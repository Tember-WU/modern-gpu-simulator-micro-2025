...
# Usage:
#   ./generate_remodeled_GPU_Microbenchmark_traces.sh -D 0
#   ./generate_remodeled_GPU_Microbenchmark_traces.sh 0
...
echo "Benchmark suite=GPU_Microbenchmark"
echo "Build target=GPU_Microbenchmark"
...
make -j"$(nproc)" -C ./gpu-app-collection/src GPU_Microbenchmark
make -C ./gpu-app-collection/src data

./util/tracer_nvbit/run_hw_trace.py -B GPU_Microbenchmark -D "$DEVICE"
